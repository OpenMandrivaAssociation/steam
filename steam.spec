...
%{_prefix}/lib/steam/steam_launcher/__init__.py
%{_prefix}/lib/steam/steam_launcher/launcherutils.py
...
%post
alternatives --set tar /usr/bin/gtar

%postun
alternative --set tar /usr/bin/bsdtar
